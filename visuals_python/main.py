...
for i in range(VARIABLES["WALL_COUNT"] , VARIABLES["WALL_COUNT"] + VARIABLES["RANDOM_WALL_COUNT"]):
    ...
    walls_array[i].point2 = Vector2D( walls_array[i].point1.x + random.randint(-VARIABLES["RANDOM_WALL_MAX_LEN"] , VARIABLES["RANDOM_WALL_MAX_LEN"]),
...
for i in range(VARIABLES["MAX_PARTICLES"]):
